...
function Trend({ sessions }: { sessions: Session[] }) {
  ...
  return <div className="chart" aria-label="Recent vital trend chart"><div className="chart-stage"><ResponsiveContainer width="100%" height={300}><AreaChart data={data} margin={{ top: 12, right: 12, bottom: 2, left: -12 }}><defs><linearGradient id="heartFill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#a65343" stopOpacity={.2}/><stop offset="100%" stopColor="#a65343" stopOpacity={0}/></linearGradient><linearGradient id="spo2Fill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#66724e" stopOpacity={.2}/><stop offset="100%" stopColor="#66724e" stopOpacity={0}/></linearGradient><linearGradient id="tempFill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#b68143" stopOpacity={.17}/><stop offset="100%" stopColor="#b68143" stopOpacity={0}/></linearGradient></defs><CartesianGrid stroke="#d7cebf" strokeDasharray="2 5" vertical={false} /><XAxis dataKey="name" axisLine={false} tickLine={false} tick={{fontSize:10, fill:'#736b5f'}} dy={8} /><YAxis axisLine={false} tickLine={false} tick={{fontSize:10, fill:'#736b5f'}} /><Tooltip cursor={{stroke:'#a89d8d', strokeDasharray:'3 4'}} contentStyle={{border:'1px solid #cabfad',borderRadius:10,fontFamily:'JetBrains Mono',boxShadow:'0 10px 30px rgba(61,48,35,.14)',background:'#fffaf1'}} labelStyle={{color:'#736b5f',marginBottom:6}} /><Area {...motion} connectNulls type="monotone" dataKey="heart" name="Heart rate · bpm" stroke="#a65343" strokeWidth={2.4} fill="url(#heartFill)" dot={{r:2.5, fill:'#fffaf1', strokeWidth:2}} activeDot={{r:5, strokeWidth:2, fill:'#fffaf1'}} /><Area {...motion} connectNulls type="monotone" dataKey="spo2" name="SpO₂ · %" stroke="#66724e" strokeWidth={2.4} fill="url(#spo2Fill)" dot={{r:2.5, fill:'#fffaf1', strokeWidth:2}} activeDot={{r:5, strokeWidth:2, fill:'#fffaf1'}} /><Area {...motion} connectNulls type="monotone" dataKey="temperature" name="Temperature · °C" stroke="#b68143" strokeWidth={2.4} fill="url(#tempFill)" dot={{r:2.5, fill:'#fffaf1', strokeWidth:2}} activeDot={{r:5, strokeWidth:2, fill:'#fffaf1'}} /></AreaChart></ResponsiveContainer></div><div className="chart-origin"><span className="source-note">Simulated data</span></div></div>
}
